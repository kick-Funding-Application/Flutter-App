...
class projectDate extends StatefulWidget {
  const projectDate({
    Key? key,
    required this.title,
    this.assetName,
  ...
  @override
  _projectDateState createState() => _projectDateState();
}

class _projectDateState extends State<projectDate> {
  ...
  void _openDatePicker() async {
    ...
    if (picked != null && picked != _selectedDate) {
      setState(() {
        ...
        charityform.projectdate = picked;
